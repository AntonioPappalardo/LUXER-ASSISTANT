const es = {
  ...
  italia:'Italia',
  messico:'México',
  paesiBassi:'Países Bajos',
  portogallo:'Portugal',
  principatoMonaco:'Principado de Monacò',
  quatar:'Quàtar',
  regnoUnito:'Reino Unido',
  russia:'Rusia',
  spagna:'España',
  svizzera:'Suiza',
  usa:'USA',
  ...
  locale: {
    ...
    monthNamesShort: ['Ene', 'Feb', 'March', 'Abril', 'May', 'Jun', 'Jul', 'Ago', 'Sept', 'Oct', 'Nov', 'Dic'],
