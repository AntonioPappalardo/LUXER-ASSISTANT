...
const UserHome = ({ navigation }) => {
        return ( <
            ScrollView style = {
                { backgroundColor: "#1B1C22", flex: 1 } } > { /*Blocco Utente*/ } <
            ...
            ImageBackground style = {
                { width: 60, height: 60, resizeMode: 'cover', justifyContent: 'center', alignItems: 'center' } }
            ...
            /View> <
            /View> <
            /LinearGradient> { /*Utente*/ } <
            View style = {
                { flexDirection: "row", flex: 1, flexWrap: 'wrap' } } >
            <
            TouchableOpacity activeOpacity = { .6 }
            style = {
                { padding: 15, flexBasis: '50%' } }
            onPress = {
            ...
            /Text> <
            View style = {
                [styles.dot_button, { backgroundColor: "rgba(0,0,0,0.2)" }] } >
            <
            ...
            /LinearGradient> <
            /TouchableOpacity> <
            /View> { /*Catalogo Outside Touchable Opacity*/ } <
            TouchableOpacity activeOpacity = { .6 }
            style = {
            ...
            onPress = {
                ...
                <
                Image style = { styles.catalogueLogo }
                source = { require('../../assets/img/undraw_screen_time_vkev.png') }
                /> <
                /View> <
                View style = {
                    { flexDirection: "row" } } >
                ...
                <
                Text style = {
                    [styles.cardTitle, { paddingBottom: 0, paddingTop: 0 }] } >
                Catalogo <
                /Text> <
