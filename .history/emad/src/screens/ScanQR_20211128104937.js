...
const ScanQR = ({ navigation }) => {
    ...
    return(
        <View>
            <BackButton style={{backgroundColor:'red'}} onPress={() => { navigation.goBack() }}/>
            <View style={styles.barcodebox}>
            <BarCodeScanner onBarCodeScanned ={scanned ? undefined: barCodeScanned} style={{marginTop:0,height:'80%', width:'100%'}} />
            </View>
        </View>
    )
