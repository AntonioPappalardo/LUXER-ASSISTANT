...
const ScanQR = ({ navigation }) => {
    ...
    return(
        <SafeAreaView>
                ...
                <BarcodeMask width={300} height={250} lineAnimationDuration={2000} showAnimatedLine={false} edgeHeight={35} edgeWidth={35} edgeBorderWidth={10} edgeColor={"green"} edgeRadius={10} outerMaskOpacity={0.8}/>
