...
import { StyleSheet, Image, View, Text, Button, Vibration, PermissionsAndroid, Appearance} from "react-native";
...
const ScanQR = ({ navigation }) => {
    ...
    const askCameraPermissionAndroid = () => {
        (async () => {
