...
const ScanQR = ({ navigation }) => {
  ...
  return (
    ...
    <View style={{ backgroundColor: colors.theme.background, flexGrow: 1 }}>
      ...
      <View style={{flex:1,flexDirection:'row',alignSelf:'center',justifyContent:'center',height:250, width:250, borderWidth:5, borderColor:'white', borderRadius:10, padding:20}} />
      </Camera>
      </View>
    </View>
  )
