...
const ScanQR = ({ navigation }) => {
  ...
  return (
    ...
    <View style={{ backgroundColor: colors.theme.background, flexGrow: 1 }}>
      ...
      <BarcodeMask width={250} height={250} showAnimatedLine={false} borde edgeHeight={35} edgeWidth={35} edgeBorderWidth={10} edgeColor={"#FFF"} edgeRadius={10} outerMaskOpacity={0.6} style={{borderColor:'red'}}/>
      </View>
    </View>
  )
