...
const ScanQR = ({ navigation }) => {
    ...
    return(
        <SafeAreaView>
                ...
                <BarcodeMask width={300} height={250} showAnimatedLine={false} edgeHeight={50} edgeWidth={50} edgeBorderWidth={10} edgeColor={"green"} edgeRadius={5} outerMaskOpacity={0.8}/>
