        ...
        return (
            <TouchableOpacity activeOpacity={.75} onPress={props.onPress} style={{ width: "75%", height: 48, alignSelf: "center" }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <Switch style={styles.switch} trackColor={{ false: "red", true: "#81b0ff" }} thumbColor={isEnabled ? "#f5dd4b" : "#f4f3f4"} ios_backgroundColor="#3e3e3e" onValueChange={toggleSwitch} value={isEnabled}/>
                </View>
                <Divider width={"100%"} />
                </TouchableOpacity>
        )
