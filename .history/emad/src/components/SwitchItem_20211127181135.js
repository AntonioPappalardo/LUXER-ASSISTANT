...
const SwitchItem = (props) => {
    ...
    if (!fontsLoaded) {
        ...
        return (
            <TouchableOpacity activeOpacity={.75} onPress={props.onPress} style={{ width: "75%", height: 48, alignSelf: "center", marginBottom:15 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop:10}}>
                    <Text style={{ color: colorTheme.theme.primary, fontFamily: "SFProDisplayMedium" }}>{props.title}</Text>
